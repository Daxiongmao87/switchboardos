...
export const HOST_ROUTE_CONTRACTS: readonly RouteAccessContract[] = [
  ...
  },
  {
    ...
    parity: {
      kind: 'exception',
      reason: 'Persisted bootstrap preset CRUD is currently IPC-only; hosted /api/bootstrap/presets lists built-in generator presets.',
    },
    mutatesState: false,
  },
  {
    ...
    parity: {
      kind: 'exception',
      reason: 'Persisted bootstrap preset CRUD is currently IPC-only.',
    },
    mutatesState: false,
  },
  {
  ...
  },
  {
    ...
    parity: {
      kind: 'exception',
      reason: 'Persisted bootstrap run CRUD is currently IPC-only.',
    },
    mutatesState: false,
  },
  {
