...
export const HOST_ROUTE_CONTRACTS: readonly RouteAccessContract[] = [
  ...
  },
  {
    ...
    parity: {
      kind: 'paired',
      peerRouteId: 'hosted:PATCH:/api/hosts/:id/group',
    },
    mutatesState: true,
  },
  {
    ...
    parity: {
      kind: 'paired',
      peerRouteId: 'hosted:PATCH:/api/hosts/:id/favorite',
    },
    mutatesState: true,
  },
  {
    ...
    parity: {
      kind: 'paired',
      peerRouteId: 'hosted:POST:/api/hosts/:id/duplicate',
    },
    mutatesState: true,
  },
  {
    ...
    parity: {
      kind: 'paired',
      peerRouteId: 'hosted:POST:/api/hosts/import',
    },
    mutatesState: true,
  },
  {
    ...
    parity: {
      kind: 'paired',
      peerRouteId: 'hosted:GET:/api/host-groups',
    },
    mutatesState: false,
  },
  {
    ...
    parity: {
      kind: 'paired',
      peerRouteId: 'hosted:GET:/api/host-groups/:id',
    },
    mutatesState: false,
  },
  {
    ...
    parity: {
      kind: 'paired',
      peerRouteId: 'hosted:POST:/api/host-groups',
    },
    mutatesState: true,
  },
  {
    ...
    parity: {
      kind: 'paired',
      peerRouteId: 'hosted:PATCH:/api/host-groups/:id',
    },
    mutatesState: true,
  },
  {
    ...
    parity: {
      kind: 'paired',
      peerRouteId: 'hosted:DELETE:/api/host-groups/:id',
    },
    mutatesState: true,
  },
  {
    ...
    parity: {
      kind: 'paired',
      peerRouteId: 'hosted:GET:/api/host-tags',
    },
    mutatesState: false,
  },
  {
    ...
    parity: {
      kind: 'paired',
      peerRouteId: 'hosted:GET:/api/host-tags/:id',
    },
    mutatesState: false,
  },
  {
    ...
    parity: {
      kind: 'paired',
      peerRouteId: 'hosted:POST:/api/host-tags',
    },
    mutatesState: true,
  },
  {
    ...
    parity: {
      kind: 'paired',
      peerRouteId: 'hosted:PATCH:/api/host-tags/:id',
    },
    mutatesState: true,
  },
  {
    ...
    parity: {
      kind: 'paired',
      peerRouteId: 'hosted:DELETE:/api/host-tags/:id',
    },
    mutatesState: true,
  },
  {
    ...
    parity: {
      kind: 'paired',
      peerRouteId: 'ipc:host-group:list',
    },
    mutatesState: false,
  },
  {
    ...
    parity: {
      kind: 'paired',
      peerRouteId: 'ipc:host-group:create',
    },
    mutatesState: true,
  },
  {
    ...
    parity: {
      kind: 'paired',
      peerRouteId: 'ipc:host-group:get',
    },
    mutatesState: false,
  },
  {
    ...
    parity: {
      kind: 'paired',
      peerRouteId: 'ipc:host-group:update',
    },
    mutatesState: true,
  },
  {
    ...
    parity: {
      kind: 'paired',
      peerRouteId: 'ipc:host-group:delete',
    },
    mutatesState: true,
  },
  {
  ...
  },
  {
    ...
    parity: {
      kind: 'paired',
      peerRouteId: 'ipc:host-tag:create',
    },
    mutatesState: true,
  },
  {
  ...
  },
  {
    ...
    parity: {
      kind: 'paired',
      peerRouteId: 'ipc:host-tag:update',
    },
    mutatesState: true,
  },
  {
    ...
    parity: {
      kind: 'paired',
      peerRouteId: 'ipc:host-tag:delete',
    },
    mutatesState: true,
  },
  {
  ...
  },
  {
    ...
    transport: 'ipc',
    route: {
      channel: 'app-host:exec',
    },
    requestValidator: 'validateGeneratedAppHostExecInput',
    identity: {
      caller: 'ipc',
      sessionRequired: false,
      appIdentityRequired: true,
    ...
    successAudit: {
      required: true,
      eventType: 'app_host_sdk.executed',
      entityType: 'host',
      entityIdSource: 'context-host-id',
      message: 'Generated app host SDK command execution completed.',
      metadata: {
        actionClass: 'app-host-sdk-route',
        mutatingOperation: true,
        remoteCommandExecution: true,
    ...
    parity: {
      kind: 'paired',
      peerRouteId: 'hosted:POST:/api/app-host/exec',
    },
    mutatesState: true,
  },
  {
  ...
  },
  {
    ...
    parity: {
      kind: 'paired',
      peerRouteId: 'hosted:GET:/api/credential-refs',
    },
    mutatesState: false,
  },
  {
    ...
    parity: {
      kind: 'paired',
      peerRouteId: 'hosted:GET:/api/credential-refs/:id',
    },
    mutatesState: false,
  },
  {
    ...
    parity: {
      kind: 'paired',
      peerRouteId: 'hosted:POST:/api/credential-refs',
    },
    mutatesState: true,
  },
  {
    ...
    parity: {
      kind: 'paired',
      peerRouteId: 'hosted:PATCH:/api/credential-refs/:id',
    },
    mutatesState: true,
  },
  {
    ...
    parity: {
      kind: 'paired',
      peerRouteId: 'hosted:DELETE:/api/credential-refs/:id',
    },
    mutatesState: true,
  },
  {
    ...
    parity: {
      kind: 'paired',
      peerRouteId: 'ipc:credential-ref:list',
    },
    mutatesState: false,
  },
  {
    ...
    parity: {
      kind: 'paired',
      peerRouteId: 'ipc:credential-ref:get',
    },
    mutatesState: false,
  },
  {
    ...
    parity: {
      kind: 'paired',
      peerRouteId: 'ipc:credential-ref:create',
    },
    mutatesState: true,
  },
  {
    ...
    parity: {
      kind: 'paired',
      peerRouteId: 'ipc:credential-ref:update',
    },
    mutatesState: true,
  },
  {
    ...
    parity: {
      kind: 'paired',
      peerRouteId: 'ipc:credential-ref:delete',
    },
    mutatesState: true,
  },
  {
  ...
  },
  {
    ...
    parity: {
      kind: 'paired',
      peerRouteId: 'ipc:host:updateGroup',
    },
    mutatesState: true,
  },
  {
    ...
    parity: {
      kind: 'paired',
      peerRouteId: 'ipc:host:setFavorite',
    },
    mutatesState: true,
  },
  {
    ...
    parity: {
      kind: 'paired',
      peerRouteId: 'ipc:host:duplicate',
    },
    mutatesState: true,
  },
  {
